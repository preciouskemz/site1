...
function filterMatches(category, btn) {
    ...
    // Remove old animation classes and hide all cards first
    cards.forEach(card => {
        card.classList.remove('float-in', 'float-in-bounce');
        for (let i = 0; i <= 8; i++) {
    ...
    // Apply staggered floating animation - swift wave effect
